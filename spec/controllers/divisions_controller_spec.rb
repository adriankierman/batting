  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested division" do
        ...
        Division.any_instance.should_receive(:update_attributes).with({ "division_name" => "MyText" })
        put :update, {:id => division.to_param, :division => { "division_name" => "MyText" }}, valid_session
      end
